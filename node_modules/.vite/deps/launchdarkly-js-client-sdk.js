...
for (s = { LDUnexpectedResponseError: t, LDInvalidEnvironmentIdError: n, LDInvalidUserError: r, LDInvalidEventKeyError: o, LDInvalidArgumentError: i, LDInvalidDataError: e("LaunchDarklyInvalidDataError"), LDFlagFetchError: a, LDTimeoutError: e("LaunchDarklyTimeoutError"), isHttpErrorRecoverable: function(e3) {
  ...
  for (n2 = 0; n2 < c2; n2 += 4) t2 = f[e3.charCodeAt(n2)] << 18 | f[e3.charCodeAt(n2 + 1)] << 12 | f[e3.charCodeAt(n2 + 2)] << 6 | f[e3.charCodeAt(n2 + 3)], a2[s2++] = t2 >> 16 & 255, a2[s2++] = t2 >> 8 & 255, a2[s2++] = 255 & t2;
  ...
  for (var t2, n2 = e3.length, r2 = n2 % 3, o2 = [], i2 = 16383, a2 = 0, s2 = n2 - r2; a2 < s2; a2 += i2) o2.push(h(e3, a2, a2 + i2 > s2 ? s2 : a2 + i2));
...
function h(e3, t2, n2) {
  for (var r2, o2, i2 = [], a2 = t2; a2 < n2; a2 += 3) r2 = (e3[a2] << 16 & 16711680) + (e3[a2 + 1] << 8 & 65280) + (255 & e3[a2 + 2]), i2.push(d[(o2 = r2) >> 18 & 63] + d[o2 >> 12 & 63] + d[o2 >> 6 & 63] + d[63 & o2]);
  return i2.join("");
}
...
var E = function e2(t2, n2) {
  ...
  if (t2 && n2 && "object" == typeof t2 && "object" == typeof n2) {
    ...
    var f = b(t2);
    if ((o2 = f.length) !== b(n2).length) return false;
    for (r2 = o2; 0 != r2--; ) if (!k.call(n2, f[r2])) return false;
...
function x(e3) {
  ...
  return y.fromByteArray(function(e4) {
    const t3 = [];
    for (let n2 = 0; n2 < e4.length; n2++) t3.push(e4.charCodeAt(n2));
    return t3;
  }(t2));
}
function C(e3, t2) {
...
var S = { appendUrlPath: function(e3, t2) {
  ...
  const t2 = {};
  for (const n2 in e3) C(e3, n2) && (t2[n2] = { value: e3[n2], version: 0 });
  return t2;
}, transformVersionedValuesToValues: function(e3) {
  const t2 = {};
  for (const n2 in e3) C(e3, n2) && (t2[n2] = e3[n2].value);
  return t2;
}, wrapPromiseCallback: function(e3, t2) {
  const n2 = e3.then((e4) => (t2 && setTimeout(() => {
    t2(null, e4);
  }, 0), e4), (e4) => {
    if (!t2) return Promise.reject(e4);
    setTimeout(() => {
      t2(e4, null);
    }, 0);
  });
...
for (A = [], j = 0; j < 256; ++j) A.push((j + 256).toString(16).substr(1));
var U;
var R;
var A;
var j;
...
var $ = 0;
function V(e3) {
  if (!L(e3)) throw TypeError("Invalid UUID");
...
function M(e3, t2, n2) {
  function r2(e4, r3, o2, i2) {
    if ("string" == typeof e4 && (e4 = function(e5) {
      ...
      for (var t3 = [], n3 = 0; n3 < e5.length; ++n3) t3.push(e5.charCodeAt(n3));
      return t3;
    }(e4)), "string" == typeof r3 && (r3 = V(r3)), 16 !== r3.length) throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
...
var G = M("v3", 48, function(e3) {
  if ("string" == typeof e3) {
    ...
    for (var n2 = 0; n2 < t2.length; ++n2) e3[n2] = t2.charCodeAt(n2);
  }
  return function(e4) {
    ...
    for (var t3 = 8 * e4.length, n3 = new Uint32Array(q(t3)), r2 = 0; r2 < t3; r2 += 8) n3[r2 >> 5] |= (255 & e4[r2 / 8]) << r2 % 32;
    return n3;
  }(e3), 8 * e3.length));
});
var W = G;
...
var Y = M("v5", 80, function(e3) {
  ...
  if ("string" == typeof e3) {
    ...
    e3 = [];
    for (var o2 = 0; o2 < r2.length; ++o2) e3.push(r2.charCodeAt(o2));
  ...
  for (var i2 = e3.length / 4 + 2, a2 = Math.ceil(i2 / 16), s = new Array(a2), c = 0; c < a2; ++c) {
    for (var u = new Uint32Array(16), l = 0; l < 16; ++l) u[l] = e3[64 * c + 4 * l] << 24 | e3[64 * c + 4 * l + 1] << 16 | e3[64 * c + 4 * l + 2] << 8 | e3[64 * c + 4 * l + 3];
    s[c] = u;
  }
...
var ee = Object.freeze({ __proto__: null, v1: function(e3, t2, n2) {
  ...
  if (l < 0 && void 0 === e3.clockseq && (a2 = a2 + 1 & 16383), (l < 0 || c > N) && void 0 === e3.nsecs && (u = 0), u >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
  N = c, $ = u, R = a2;
...
var ne = { commonBasicLogger: function(e3, t2) {
  if (e3 && e3.destination && "function" != typeof e3.destination) throw new Error("destination for basicLogger was set to a non-function");
  function n2(e4) {
    return function(t3) {
  ...
  let a2 = 1;
  if (e3 && e3.level) for (let t3 = 0; t3 < te.length; t3++) te[t3] === e3.level && (a2 = t3);
  function s(e4, n3, a3) {
  ...
  te.forEach((t2) => {
    if ("none" !== t2 && (!e3[t2] || "function" != typeof e3[t2])) throw new Error("Provided logger instance must support logger." + t2 + "(...) method");
  });
} };
function re(e3) {
...
function le(e3, t2, n2) {
  ...
  } else n2.warn(ie.invalidTagValue(e3));
}
var de = { baseOptionDefs: se, validate: function(e3, t2, n2, r2) {
  ...
  return function(e4) {
    ...
    const t3 = S.extend({}, e4), n3 = (e5) => {
      if (null === e5) return "any";
      if (void 0 === e5) return;
      if (Array.isArray(e5)) return "array";
      const t4 = typeof e5;
    ...
    return Object.keys(e4).forEach((i3) => {
      ...
      if (null != s) {
        const c2 = o2[i3];
        if (void 0 === c2) a2(ie.unknownOption(i3));
        else {
...
var he = function(e3, t2, n2) {
  ...
  return o2.sendEvents = (t3, o3, i2) => {
    if (!e3.httpRequest) return Promise.resolve();
    ...
    return function t4(u) {
      ...
      return e3.httpRequest("POST", o3, me(l, n2), a2).promise.then((e4) => {
        if (e4) return e4.status >= 400 && s.isHttpErrorRecoverable(e4.status) && u ? t4(false) : function(e5) {
...
var ke = { checkContext: function(e3, t2) {
  if (e3) {
    if (t2 && (void 0 === e3.kind || null === e3.kind)) return void 0 !== e3.key && null !== e3.key;
  ...
  if (e3) {
    if ((void 0 === e3.kind || null === e3.kind || "user" === e3.kind) && e3.key) return e3.key;
    if ("multi" !== e3.kind && e3.key) return `${e3.kind}:${be(e3.key)}`;
    if ("multi" === e3.kind) return Object.keys(e3).sort().filter((e4) => "kind" !== e4).map((t2) => `${t2}:${be(e3[t2].key)}`).join(":");
  }
} };
...
var Oe = { cloneExcluding: function(e3, t2) {
  ...
  for (n2.push(...Object.keys(e3).map((t3) => ({ key: t3, ptr: Ie(t3), source: e3, parent: r2, visited: [e3] }))); n2.length; ) {
    const e4 = n2.pop();
    if (t2.some((t3) => Se(t3, e4.ptr))) o2.push(e4.ptr);
    else {
      const t3 = e4.source[e4.key];
      if (null === t3) e4.parent[e4.key] = t3;
      else if (Array.isArray(t3)) e4.parent[e4.key] = [...t3];
      else if ("object" == typeof t3) {
        if (e4.visited.includes(t3)) continue;
...
var Te = function(e3) {
  const t2 = {}, n2 = e3.allAttributesPrivate, r2 = e3.privateAttributes || [], o2 = ["key", "kind", "_meta", "anonymous"], i2 = ["name", "ip", "firstName", "lastName", "email", "avatar", "country"], a2 = (e4, t3) => {
    if ("object" != typeof e4 || null === e4 || Array.isArray(e4)) return;
  ...
  return t2.filter = (e4, t3 = false) => void 0 === e4.kind || null === e4.kind ? a2(((e5) => {
    ...
    for (const n3 of i2) delete t4[n3], void 0 !== e5[n3] && null !== e5[n3] && (t4[n3] = String(e5[n3]));
...
var Re = function(e3) {
  ...
  return t2.on = function(e4, t3, r2) {
    ...
    if (n2[e4]) for (let o2 = 0; o2 < n2[e4].length; o2++) n2[e4][o2].handler === t3 && n2[e4][o2].context === r2 && (n2[e4] = n2[e4].slice(0, o2).concat(n2[e4].slice(o2 + 1)));
  }, t2.emit = function(e4) {
    if (!n2[e4]) return;
    const t3 = n2[e4].slice(0);
    for (let e5 = 0; e5 < t3.length; e5++) t3[e5].handler.apply(t3[e5].context, Array.prototype.slice.call(arguments, 1));
...
var Je = function(e3, t2, n2, r2) {
  ...
  function k2(e4) {
    if (e4.status && "number" == typeof e4.status && !_e(e4.status)) return x2(), i2.error(ie.unrecoverableStreamError(e4)), void (p && (clearTimeout(p), p = null));
    const t3 = b2();
  ...
  function D2() {
    ...
    if (e3.eventSourceFactory) {
      ...
      for (const e4 in y2) He(y2, e4) && v.addEventListener(e4, y2[e4]);
  ...
  return a2.connect = function(e4, t3, n3) {
    m2 = e4, h2 = t3, y2 = {};
    for (const e5 in n3 || {}) y2[e5] = function(t4) {
...
var Qe = function(e3, t2, n2) {
  ...
  function l(n3, r3) {
    if (!e3.httpRequest) return new Promise((e4, t3) => {
    ...
    const c2 = e3.httpRequest(o3, n3, Ge(i3, t2), r3), l2 = c2.promise.then((e4) => {
      if (200 === e4.status) {
        if (e4.header("content-type") && e4.header("content-type").substring(0, 16) === Xe) return JSON.parse(e4.body);
        {
...
var tt = function(e3) {
  ...
  this.processContext = (e4) => {
    if (!e4) return Promise.reject(new s.LDInvalidUserError(ie.contextNotSpecified()));
    const t3 = S.clone(e4);
    if ("multi" === e4.kind) {
      const e5 = et(t3);
...
var it = { DiagnosticId: function(e3) {
  ...
  return p.start = () => {
    s ? function(e4) {
      if (!t2.isEnabled()) return e4(false);
      t2.get(c).then((t3) => {
        if (t3) try {
...
var wt = { initialize: function(e3, t2, n2, r2, o2) {
  ...
  function z2() {
    if (x2 = true, !R.getContext()) return;
    const e4 = (e5) => {
      try {
    ...
    b2.connect(R.getContext(), g, { ping: function() {
      ...
      } else i2.debug(ie.debugStreamPatchIgnored(n3.key));
    }, delete: function(t3) {
      const n3 = e4(t3.data);
      if (n3) if (!P2[n3.key] || P2[n3.key].version < n3.version) {
      ...
      } else i2.debug(ie.debugStreamDeleteIgnored(n3.key));
    } });
  }
  function K2() {
  ...
  function _2(e4) {
    const t3 = {};
    if (!e4) return Promise.resolve();
    for (const n3 in P2) S.objectHasOwnProperty(P2, n3) && P2[n3] && (e4[n3] && !S.deepEquals(e4[n3].value, P2[n3].value) ? t3[n3] = { previous: P2[n3].value, current: H2(e4[n3]) } : e4[n3] && !e4[n3].deleted || (t3[n3] = { previous: P2[n3].value }));
    for (const n3 in e4) S.objectHasOwnProperty(e4, n3) && e4[n3] && (!P2[n3] || P2[n3].deleted) && (t3[n3] = { current: H2(e4[n3]) });
  ...
  if ("string" == typeof u.bootstrap && "LOCALSTORAGE" === u.bootstrap.toUpperCase() && (j ? D2 = true : i2.warn(ie.localStorageUnavailable())), "object" == typeof u.bootstrap && (P2 = function(e4) {
    ...
    if (!e3) return Promise.reject(new s.LDInvalidEnvironmentIdError(ie.environmentNotSpecified()));
  ...
  const Y2 = { waitForInitialization: function(e4 = void 0) {
    if (null != e4) {
      if ("number" == typeof e4) return function(e5) {
    ...
    if (T2) return S.wrapPromiseCallback(Promise.resolve({}), n3);
    if (U) return i2.warn(ie.identifyDisabled()), S.wrapPromiseCallback(Promise.resolve(S.transformVersionedValuesToValues(P2)), n3);
    ...
    if ("string" != typeof e4) return void a2.maybeReportError(new s.LDInvalidEventKeyError(ie.unknownCustomEventKey(e4)));
    ...
    const e4 = {};
    if (!P2) return e4;
    for (const t3 in P2) S.objectHasOwnProperty(P2, t3) && !P2[t3].deleted && (e4[t3] = q2(t3, null, !u.sendEventsOnlyForVariation, false, true, false).value);
    return e4;
  }, close: function(e4) {
    if (T2) return S.wrapPromiseCallback(Promise.resolve(), e4);
    const t3 = () => {
      T2 = true, P2 = {};
    }, n3 = Promise.resolve().then(() => {
      if (K2(), w2 && w2.stop(), d) return k2.stop(), k2.flush();
    }).then(t3).catch(t3);
...
function Ot(e3, t2, n2, r2, o2) {
  ...
  for (var a2 in i2.open(e3, t2, !o2), n2 || {}) Object.prototype.hasOwnProperty.call(n2, a2) && i2.setRequestHeader(a2, n2[a2]);
  if (o2) {
    try {
      i2.send(r2);
    } catch (e4) {
...
function Ut(e3, t2) {
  for (var n2 = {}, r2 = null, o2 = [], i2 = 0; i2 < e3.length; i2++) for (var a2 = e3[i2], s = a2.urls || [], c = 0; c < s.length; c++) if (Lt(s[c], window.location.href, window.location.search, window.location.hash)) {
  ...
  return o2.length > 0 && (r2 = function(e4) {
    for (var n3 = function(e5, t3) {
      for (var n4 = [], r4 = 0; r4 < t3.length; r4++) for (var o3 = e5.target, i3 = t3[r4], a3 = i3.selector, s2 = document.querySelectorAll(a3); o3 && s2.length > 0; ) {
        for (var c2 = 0; c2 < s2.length; c2++) o3 === s2[c2] && n4.push(i3);
        o3 = o3.parentNode;
      }
      return n4;
    }(e4, o2), r3 = 0; r3 < n3.length; r3++) t2("click", n3[r3]);
